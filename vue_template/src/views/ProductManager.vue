  ...
  <div class="product-manager">
    ...
    <el-card class="operation-area" shadow="hover">
      ...
      <div class="operation-buttons">
        <el-button v-if="userInfo.role==='FARMER'" plain size="medium" type="primary" icon="el-icon-plus" class="add-button" @click="handleAdd">新增商品</el-button>
...
export default {
  ...
  methods: {
    ...
    // 获取商品列表
    async getList() {
      if(this.userInfo.role === 'FARMER'){
        this.queryParams.farmerId = this.userInfo.id
      }
      try {
        const params = {
          ...this.queryParams,
    ...
    submitForm() {
      // if(this.form.)
      if(this.userInfo.role==='FARMER'){
        this.form.farmerId=this.userInfo.id
